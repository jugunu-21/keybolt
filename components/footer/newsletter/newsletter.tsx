      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-300"> Get the latest updates, tips, and resources to help your food business thrive.. Sign up for our newsletter today.</p>
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              {email && (
                <button onClick={handleSubmit} type="submit" className="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Subscribe</button>)}
            </div>
          </div>
